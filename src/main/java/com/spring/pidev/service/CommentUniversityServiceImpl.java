...
import com.spring.pidev.repo.CommentUniversityRepository;
import com.spring.pidev.repo.IPartnerRepository;
import com.spring.pidev.repo.UserRepository;
import com.spring.pidev.sentimentAnalyzer.Sentiment;
import com.spring.pidev.sentimentAnalyzer.SentimentResult;
import com.spring.pidev.util.FilterBW;
...
public class CommentUniversityServiceImpl implements ICommentUniversityService{
    ...
    public void addSignal(Long IdComment) {
        ...
        commentUniversity.setNbrSignal(commentUniversity.getNbrSignal()+1);
        commentrepo.save(commentUniversity);
